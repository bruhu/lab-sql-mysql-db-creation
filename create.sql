...
CREATE TABLE customers (customer_id INT, name VARCHAR(255), phone_number VARCHAR(15), email VARCHAR(255) NOT NULL, address TEXT, city VARCHAR(100), state_province VARCHAR(100), country VARCHAR(100), zip_code VARCHAR(20));
